...
# Scalable LDA Insights Framework (SLIF). It leverages Dask for distributed, adaptive parallel processing
...
def train_model_v2(client, n_topics: int, alpha_str: Union[str, float], beta_str: Union[str, float], data: list, phase: str,
    ...
    'num_workers': len(client.scheduler_info()["workers"]),  # Adaptive core count used for this batch.
